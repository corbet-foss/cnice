...
Version 0.1.0 is published to registries.
...
See the [installation guide](https://github.com/corbet-foss/cnice/blob/main/docs/installation.md)
...
See [the release guide](https://github.com/corbet-foss/cnice/blob/main/docs/releasing.md)
...
See the [licensing notes](https://github.com/corbet-foss/cnice/blob/main/LICENSE.md) for distribution conditions and retained notices.
