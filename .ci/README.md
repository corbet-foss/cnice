...
| `typst-preview` | Exact prepared Universe archive and README examples importing `@preview/cnice:0.1.2` |
...
`deno publish --dry-run --allow-dirty`, and exports `cnice-0.1.2-jsr.tar.gz` with a
  ...
  "artifacts": [
    {
      "kind": "wheel",
      "name": "cnice",
      "path": "/absolute/path/to/verified/cnice.whl",
